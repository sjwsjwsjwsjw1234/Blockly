...
public class DatabaseManager {
     ...
     * @throws DatabaseException If there was an error in accessing the database.
     */
     ...
     *
     * @param statement The SQL statement to query
     * @param values    Ordered list of arguments to substitute
     ...
     * @throws JSONException     If there was an error encoding or decoding JSON
     * @throws DatabaseException If there was an error in accessing the database.
     */
