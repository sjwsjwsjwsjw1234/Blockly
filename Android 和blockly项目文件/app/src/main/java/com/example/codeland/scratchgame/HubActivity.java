package com.example.codeland.scratchgame;
...
import com.example.codeland.scratchgame.fragment.AnimationModelFragment;
import com.example.codeland.scratchgame.fragment.GameModelFragment;
import com.example.codeland.scratchgame.fragment.LevelFragment;
import com.example.codeland.scratchgame.fragment.NotebookFragment;
        ...
        switch (v.getId()){
            ...
            case R.id.hub_part3:
                if(part!=3){
                    ...
                    replaceLeftBottomFragment(new LevelFragment());
                    part=3;
                    setPartColor(part);
                }
                break;
