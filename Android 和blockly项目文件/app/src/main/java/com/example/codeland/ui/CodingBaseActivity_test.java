...
//                }
        ...
        quit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                BmobUser.logOut();
                Toast.makeText(CodingBaseActivity_test.this, "退出成功", Toast.LENGTH_LONG).show();
            ...
            public void editInputFinished(String name) {
                ...
                codingPlace.save(new SaveListener<String>() {
                    ...
                    public void done(String s, BmobException e) {
                        if(e==null){
                            Toast.makeText(CodingBaseActivity_test.this, "添加数据成功", Toast.LENGTH_LONG).show();
                            onCreate(null);
                        }else{
                            Toast.makeText(CodingBaseActivity_test.this, "创建数据失败,网络请求超时", Toast.LENGTH_LONG).show();
                        }
                    }
                });
    ...
    private void loadRecord() {
        ...
        String bql ="select * from CodingPlace";//查询所有记录
            ...
            public void done(BmobQueryResult<CodingPlace> result, BmobException e) {
                if(e ==null){
                    ...
                    if(savingRecordList!=null && savingRecordList.size()>0){
                        ...
                        Toast.makeText(CodingBaseActivity_test.this, "讨论区还没内容哦！", Toast.LENGTH_LONG).show();
                    }
                } else {
                    Log.i("smile", "错误码："+e.getErrorCode()+"，错误描述："+e.getMessage());
                    Toast.makeText(CodingBaseActivity_test.this, "数据请求超时", Toast.LENGTH_LONG).show();
                }
            }
        });
                                ...
                                if (e == null) {
                                    ...
                                    codingPlace2.delete(object.get(0).getObjectId(),new UpdateListener(){
                                        ...
                                        public void done(BmobException e) {
                                            if (e == null) {
                                                Toast.makeText(CodingBaseActivity_test.this,"删除成功。",Toast.LENGTH_SHORT).show();
                                            }else {
                                                Toast.makeText(CodingBaseActivity_test.this,"删除失败。",Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    });
                                } else {
                                    Log.e("BMOB", e.toString());
                                    Toast.makeText(CodingBaseActivity_test.this,"查询失败。",Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    }
                        ...
                        public void done(List<CodingPlace> object, BmobException e) {
                            if (e == null) {
                                ...
                                codingPlace2.update(object.get(0).getObjectId(),new UpdateListener(){
                                    ...
                                    public void done(BmobException e) {
                                        if (e == null) {
                                            Toast.makeText(CodingBaseActivity_test.this,"更新成功。",Toast.LENGTH_SHORT).show();
                                        }else {
                                            Toast.makeText(CodingBaseActivity_test.this,"更新失败。",Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                            } else {
