...
import com.example.codeland.ParallelViewHelper;
...
import com.example.codeland.car.TurtleActivity;
...
public class GameBaseActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private int[] imageid={R.mipmap.car, R.mipmap.car, R.mipmap.car};
    ...
    private int[] moduleBackground={R.drawable.module_fillet_red, R.drawable.module_fillet_yellow, R.drawable.module_fillet_blue};
...
//        String[] moduleName={getString(R.string.gamebase_tadpole),getString(R.string.gamebase_turtle),getString(R.string.gamebase_pacman),getString(R.string.gamebase_box),getString(R.string.dig_treasure),getString(R.string.gamebase_more_games)};
        String[] moduleName={"按键控制", "语音控制", "Blockly控制"};
...
//                break;
            ...
            case 0:
                MyApplication.playClickVoice(GameBaseActivity.this,"button");
                intent=new Intent(GameBaseActivity.this, DirectionActivity.class);
                intent.putExtra("model","turtle");
                startActivity(intent);
                break;
            case 1:
                intent=new Intent(GameBaseActivity.this, SpeechActivity.class);
                //intent.putExtra("model","pacman");
                startActivity(intent);
                break;
            //Box游戏中有bug，正式发布时屏蔽此游戏
            case 2:
                intent=new Intent(GameBaseActivity.this, BlocklyControlActivity.class);
