...
public class ProgramCodingFragment extends Fragment implements View.OnClickListener {
    ...
    private int[] imageId={R.mipmap.coding_module_printf_chinese, R.mipmap.coding_module_math, R.mipmap.coding_module_variable
            , R.mipmap.coding_module_logic, R.mipmap.coding_module_loop, R.mipmap.coding_module_array,R.mipmap.coding_module_printf_chinese};
    private int[] moduleBackground={R.drawable.module_fillet_blue, R.drawable.module_fillet_red, R.drawable.module_fillet_green,
            R.drawable.module_fillet_pink, R.drawable.module_fillet_yellow, R.drawable.module_fillet_purple,R.drawable.module_fillet_blue};
    ...
    public void onStart() {
        super.onStart();
        String[] moduleName={getString(R.string.coding_output_text),getString(R.string.coding_math),getString(R.string.coding_variable),getString(R.string.coding_logic),getString(R.string.coding_loop),getString(R.string.coding_array),getString(R.string.coding_function)};
    ...
    public void onClick(View view) {
        ...
        switch (view.getId())
        {
            case 0:
                ...
                editor.commit();
                changeParentFragment(new BaseLevelFragment(),"coding_printf");
                break;
            case 1:
                MyApplication.playClickVoice(getActivity(),"button");
                editor.putInt("clickedChapter",2);
                editor.commit();
                changeParentFragment(new BaseLevelFragment(),"coding_math");
                break;
            case 2:
                MyApplication.playClickVoice(getActivity(),"button");
                editor.putInt("clickedChapter",3);
                editor.commit();
                changeParentFragment(new BaseLevelFragment(),"coding_variable");
                break;
            case 3:
                MyApplication.playClickVoice(getActivity(),"button");
                editor.putInt("clickedChapter",4);
                editor.commit();
                changeParentFragment(new BaseLevelFragment(),"coding_logic");
                break;
            case 4:
                MyApplication.playClickVoice(getActivity(),"button");
                editor.putInt("clickedChapter",5);
                editor.commit();
                changeParentFragment(new BaseLevelFragment(),"coding_loop");
                break;
            case 5:
                MyApplication.playClickVoice(getActivity(),"button");
                editor.putInt("clickedChapter",6);
                editor.commit();
                changeParentFragment(new BaseLevelFragment(),"coding_array");
                break;
            case 6:
                MyApplication.playClickVoice(getActivity(),"button");
                editor.putInt("clickedChapter",6);
                editor.commit();
                changeParentFragment(new BaseLevelFragment(),"coding_function");
                break;
        }
